...
layout: splash
permalink: /
title: "動物が季節に適応する巧みな生存戦略、その分子機構に迫る"
header:
  overlay_color: "#000"
  overlay_filter: "0.5"
...
季節に応じて活動や代謝、行動を変化させる仕組みは、温帯に生息する動物に共通してみられる巧みな生存戦略です。当研究室では、メダカをはじめとする水生生物をモデルに、こうした季節・温度適応を支える分子メカニズムを、分子生物学からゲノム解析、行動解析まで幅広いアプローチで明らかにすることを目指しています。
